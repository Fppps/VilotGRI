...
window.switchActiveModel = function(modelName) {
  ...
  if (modelName === 'vilotni_1') {
    ...
    if (heroDesc) heroDesc.textContent = "A substantial advancement over VilotNI 1, featuring a 3-million-neuron activation layer, adaptive learning, and no hardcoded responses, with high, medium & low in existence. High is the most proforming at giving comprehensable & closely-accurate response, medium is well at learning & semi-accrate response, low is good at learning, but drifts to easily to lala-land.";

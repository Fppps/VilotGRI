 ...
 *
 * Goal:
 *   Deep = true neural autoregression + light RSL constraints + beam search + final verifier.
...
class RLEngine {
  constructor(network) {
    ...
    // V27 deliberately starts a fresh RSL decoder-learning namespace.
    // Existing V23/V22 localStorage is left untouched, but it is NOT imported
    // unless rslImportLegacyPersistence is explicitly enabled for an experiment.
    this.persistenceKey = "vilotni15_rsl_decoder_v27";
    this.legacyPersistenceKey = "vilotni15_rsl_type_phrase_v23";
  ...
  async generate(rawPromptTokens, onProgress = null) {
    ...
    // ================================================================
    // RSL v26 DEEP: TRUE PREFIX NEURAL REFRESH + RSL CONSTRAINED SEARCH
    // ================================================================

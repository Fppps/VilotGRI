 ...
 * Total parameters: 800k weights + 200k biases = 1M float values (4 MB).
 */
class Sparse200kLayer {
  constructor(layerIndex, prevSize = 200000, currentSize = 200000, fanIn = 4) {
    ...
    // Synaptic weights: fanIn per neuron
  ...
  forward(prevActivations) {
    ...
    for (let i = 0; i < this.size; i++) {
      ...
      // Prime hash formula establishes uniform deterministic synaptic connectivity
